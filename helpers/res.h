...
#define IDS_FILEFILTER_BIN  "Бинарный файл эмулятора (.bin)|*.bin|Все файлы (*.*)|*.*||"
#define IDS_FILEFILTER_BKHDDIMG  "Образ жёсткого диска БК (.hdi)|*.hdi|Все файлы (*.*)|*.*||"
#define IDS_FILEFILTER_BKIMG  "Образ диска БК (.img, .bkd, .dsk)|*.img;*.bkd;*.dsk|Все файлы (*.*)|*.*||"
#define IDS_FILEFILTER_IMGLOAD  "Все файлы изображений"
#define IDS_FILEFILTER_MSF  "Файл состояния памяти (.msf)|*.msf|Все файлы (*.*)|*.*||"
#define IDS_FILEFILTER_TAPE_LOAD  
#define IDS_FILEFILTER_TAPE_SAVE  
#define IDS_FILEFILTER_TAP_ONLY  "Файл кассеты БК (.tap)|*.tap|Все файлы (*.*)|*.*||"
#define IDS_FILEFILTER_WAV  "Microsoft Wave (.wav)|*.wav|Все файлы (*.*)|*.*||"
