...
const char *res_str[] = {
 ...
 "Образ жёсткого диска БК (.hdi)|*.hdi|Все файлы (*.*)|*.*||",
 "Образ диска БК (.img, .bkd, .dsk)|*.img;*.bkd;*.dsk|Все файлы (*.*)|*.*||",
 "Все файлы изображений",
 "Файл состояния памяти (.msf)|*.msf|Все файлы (*.*)|*.*||",
 "",
 "",
 "Файл кассеты БК (.tap)|*.tap|Все файлы (*.*)|*.*||",
 "Microsoft Wave (.wav)|*.wav|Все файлы (*.*)|*.*||",
